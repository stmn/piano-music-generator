...
- `itch/` - everything for the itch.io page: store description, setup notes with the palette,
  cover and infographics. `tools/build-itch.sh` packs the four runtime files into the upload zip.
